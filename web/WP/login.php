...
<head>
    ...
    <body>
            ...
            <section>
                <div class="container" style="max-width:350px;margin-top:100px;margin-bottom:250px;">
                <form action="action.php" method="POST">
                        ...
                        <br>
                        <button type="submit" class="btn btn-primary" name="btn-login_user">Submit</button>
                    </form>
                </div>
            </section>
