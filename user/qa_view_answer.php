              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label class="form-control-label">Course: </label>
                    <input type="text" name="course" class="form-control" value="<?= $DATA['course_name'] ?>" disabled>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label class="form-control-label">File: </label><br>
                    ...
                    <a href="PDF.php?file=<?= $data['question']  ?>"><button class="btn btn-purple">Download Question</button></a>
                </div>
              </div>
            ...
            <form action="action.php" method="POST"  enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="form-control-label">File: </label><br>
                      <input type="file"  name="upload[]" multiple="on" class="form-control"><br>
