            ...
            <div class="col-md-6">
                  <div class="form-group">
                    <label class="form-control-label">Posted By: </label>
                      <input type="text" name="owner" class="form-control" value="<?= postOwner($db, $post['user_id']) ?? "" ?>" disabled>
                  </div>
                </div>
                ...
                <div1 class="col-md-6">
                  <div class="form-group">
                    <label class="form-control-label">Posted At: </label>
                      <input type="text" name="owner" class="form-control" value="<?= $post['created_at'] ?? "" ?>" disabled>
                  </div>
                </div>
              <div class="col-md-12">
                  <div class="form-group">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label class="form-control-label">Details: </label>
                      <textarea name="details" class="form-control" cols="30" rows="10" disabled><?= $post['details'] ?? "" ?></textarea>
                  </div>
                </div>
                  ...
                  <div class="form-layout">
                    ...
                    <input type="hidden" name="post_id" value="<?= $post['id'] ?>">
                          <div class="row">
                            ...
                            <div class="col-md-12">
                                <button type="submit" name="btn_CommenSubmit" class="btn btn-primary">Submit</button>
                            </div>
                          </div>
                    </form>
                  </div>
